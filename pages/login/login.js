...
function initLogin() {
    ...
    form.addEventListener("submit", async (event) => {
        ...
        try {
            const response = await fetch("https://monster-reviews-api.onrender.com/api/auth/login", {
                method: "POST",
...
function initCadastro() {
    document.getElementById("formCadastro").addEventListener("submit", async (e) => {
        ...
        try {
            const resposta = await fetch("https://monster-reviews-api.onrender.com/api/auth/cadastro", {
                method: "POST",
                headers: { "Content-Type": "application/json" },
...
function initRecuperacao() {
    ...
    formRecuperacao.addEventListener('submit', async (e) => {
        ...
        try {
            const resposta = await fetch('https://monster-reviews-api.onrender.com/api/esqueci-senha', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
...
function initReset() {
    ...
    formReset.addEventListener('submit', async (e) => {
        ...
        try {
            const resposta = await fetch('https://monster-reviews-api.onrender.com/api/resetar-senha', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({ 
